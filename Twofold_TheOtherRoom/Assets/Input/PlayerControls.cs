...
public partial class @PlayerControls: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""id"": ""285fa767-63a4-41d0-92ba-0ac6e41b600f"",
            ""actions"": [
                {
                    ""name"": ""Movement"",
                    ""type"": ""Value"",
                    ""id"": ""6483d847-3c28-4598-ab74-0cf16b1f717e"",
                ...
                },
                {
                    ""name"": ""Look"",
                    ""type"": ""Value"",
                    ""id"": ""1858f6ee-348e-4d0a-94ba-8c4fcb38a36c"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
                ...
                },
                {
                    ""name"": ""Sprint"",
                    ""type"": ""Button"",
                    ""id"": ""c9d1e4b6-7a25-4f38-9e0c-1b2c3d4e5f60"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": ""WASD"",
                    ""id"": ""72ef825e-854c-4427-96cd-b6771afb5634"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""345c734a-6455-495b-8bd9-ade2733db5b0"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""84e632f0-4eb7-4309-a737-2295258780db"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""97e5c00c-190e-406c-b240-fe19111161a4"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""182f6773-f60b-4e7b-a842-b6ddb9832fa0"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""Left Stick"",
                    ""id"": ""8574ce2d-1d23-4b5c-9ae5-7ed5908ad619"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""38e0a475-5437-40b1-bd8d-a48a4a2393c4"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""7d11a0a6-31b8-475d-9696-bbf6b9e89d7e"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""cded6f48-cb91-4e06-83bc-84c176658eb8"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""775b295c-ef8a-4d3f-bd92-2f930602848f"",
                ...
                {
                    ""name"": """",
                    ""id"": ""2463ffa8-50ca-4921-a2f8-a4813e1cecd2"",
                    ""path"": ""<Mouse>/delta"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""b8e4d3f2-0c5e-4f7b-9d2a-3e4f5a6b7c8d"",
                    ""path"": ""<Mouse>/rightButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""EnableCameraLook"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                },
                {
                    ""name"": """",
                    ""id"": ""d0e2f5c7-8b36-4a49-8f1d-2c3d4e5f6a71"",
    ...
    ""controlSchemes"": []
        ...
        m_PlayerLocomotionMap_EnableCameraLook = m_PlayerLocomotionMap.FindAction("EnableCameraLook", throwIfNotFound: true);
    ...
    private readonly InputAction m_PlayerLocomotionMap_EnableCameraLook;
    ...
    public struct PlayerLocomotionMapActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "PlayerLocomotionMap/EnableCameraLook".
        /// </summary>
        public InputAction @EnableCameraLook => m_Wrapper.m_PlayerLocomotionMap_EnableCameraLook;
        /// <summary>
        ...
        public void AddCallbacks(IPlayerLocomotionMapActions instance)
        {
            ...
            @EnableCameraLook.started += instance.OnEnableCameraLook;
            @EnableCameraLook.performed += instance.OnEnableCameraLook;
            @EnableCameraLook.canceled += instance.OnEnableCameraLook;
    ...
    public interface IPlayerLocomotionMapActions
    {
        ...
        /// <summary>
        /// Method invoked when associated input action "EnableCameraLook" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnEnableCameraLook(InputAction.CallbackContext context);
        /// <summary>
